# <img src="src/main/resources/logo.png" width="40"> - CoreAPI

The CoreAPI provides essential features and access to the internal server core of Themeparkcraft, used in all modules.
...
<repository>
    <id>github</id>
    <url>https://maven.pkg.github.com/Themeparkcraft/CoreAPI</url>
    <snapshots>
...
<dependency>
    <groupId>themeparkcraft.core</groupId>
...
4. Add a meaningful name in the **Note** field (e.g., "Themeparkcraft" or "CoreAPI").
